 ...
 */
function BloodRenderable(myTexture) {
...
gEngine.Core.inheritPrototype(BloodRenderable, Renderable);
 ...
 * @returns {void}
 */
BloodRenderable.prototype.draw = function (aCamera) {
 ...
 */
BloodRenderable.prototype.getTexture = function () { return this.mTexture; };
 ...
 * @returns {void}
 */
BloodRenderable.prototype.setTexture = function (newTexture) {
