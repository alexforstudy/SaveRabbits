...
function Door(cx, cy, texture0, texture1, texture2) {
    ...
    var rigidShape = new RigidRectangle(this.getXform(), this.kWidth*0.8, this.kHeight-38 );
    rigidShape.setMass(0);  // ensures no movements!
    rigidShape.setDrawBounds(true);
    rigidShape.setColor([0, 1, 1, 1]);
...
Door.prototype.buildSprite = function (atX, atY) {
    ...
    this.mDoorTopSleeve.getXform().setPosition(atX, atY + 25);
    ...
    this.mDoorBotSleeve.getXform().setPosition(atX, atY - 25);
...
//         this.mDoorBot.getXform().incYPosBy(-0.05)
    ...
    //}
        ...
        this.mDoorTopSleeve.setElementPixelPositions(128, 256, 312, 512);
